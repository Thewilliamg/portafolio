...
const Projects = () => {
    ...
    return (
        <div className={`flex flex-col items-center justify-start pt-20 gap-12 h-svh bg-[#021d34] text-[#82acce]`}>
                    ...
                    <div className="flex gap-10 px-10 justify-center">
                        ...
                        <a name="card_a" href="https://github.com/Thewilliamg/foodLover" target="_blank" rel="noreferrer" alt="Ver codigo" className="bg-red-400 w-1/5 flex rounded-xl overflow-hidden">
                            <div name="card" className="w-full hover:bg-orange-700 hover:cursor-pointer h-72 bg-orange-600 box-content rounded-md p-4 flex justify-center items-center flex-col">
                                ...
                                <div name="icons" className="w-full flex justify-center gap-4 mt-2">
                        ...
                        <a name="card_a" href="https://github.com/Thewilliamg/proyectoJavascript" target="_blank" rel="noreferrer" alt="Ver codigo" className="bg-red-400 w-1/5 flex rounded-xl overflow-hidden">
                            <div name="card" className="w-full hover:bg-orange-700 hover:cursor-pointer h-72 bg-orange-600 box-content rounded-md p-4 flex justify-center items-center flex-col">
                                ...
                                <div name="icons" className="w-full flex justify-center mt-2 items-center gap-4">
                                    <img className="w-[25px]" src="https://cdn-icons-png.flaticon.com/512/174/174854.png" alt="html" />
                                    <img className="w-[30px] h-[30px]" src="https://cdn.icon-icons.com/icons2/1488/PNG/512/5351-css3_102605.png" alt="css" />
                                    <img className="w-[25px] h-[24px]" src="https://cdn-icons-png.flaticon.com/512/5968/5968292.png" alt="js" />
                                </div>
                                <small className="w-full mb-2 block font-semibold text-[#021d34]">En este proyecto lo que realizamos fue usar algunos objetos disponibles de la API de Spotify. El reto de este proyecto fue consumir los endpoints en funcion a un parametro dado.</small>
                            </div>
                        </a>
                        ...
                        <a name="card_a" href="https://github.com/Thewilliamg/ExerciseMERN" target="_blank" alt="Ver codigo" rel="noreferrer" className="bg-red-400 w-1/5 flex rounded-xl overflow-hidden">
                            <div name="card" className="w-full hover:bg-orange-700 hover:cursor-pointer h-72 bg-orange-600 box-content rounded-md p-4 flex justify-center items-center flex-col">
                                ...
                                <small className="w-full mb-2 block font-semibold text-[#021d34]">Este fue mi primer proyecto usando en la estructura al cliente y servidor por separado. El reto de este proyecto estuvo en la implementacion de React para el frontEnd.</small>
                            </div>
                        </a>
                        ...
                        <a name="card_a" href="https://github.com/Thewilliamg/ProyectoMongoII" target="_blank" rel="noreferrer" alt="Ver codigo" className="bg-red-400 w-1/5 flex rounded-xl overflow-hidden">
                            <div name="card" className="w-full hover:bg-orange-700 hover:cursor-pointer h-72 bg-orange-600 box-content rounded-md p-4 flex justify-center items-center flex-col">
                                ...
                                <small className="w-full mb-2 block font-semibold text-[#021d34]">Este proyecto tuvo una logica interesante, aparte de usar una base de datos y usar endpoints generados con expressJS para gestionarla.</small>
                            </div>
                        </a>

                        <div className="bg-red-400 w-1/5 flex rounded-xl overflow-hidden">
                            <div name="card" className="w-full hover:bg-orange-700 hover:cursor-pointer h-72 bg-orange-600 box-content rounded-md p-4 flex justify-center items-center flex-col">
                                <h2 className="font-bold text-3xl mb-2 text-[#021d34]">Multiservicios</h2>
                                    <div className="w-full flex gap-2 justify-center text-center mb-4 mt-4">
                                        Imagen no disponible por derechos de autor
                                    </div>
