const liClass = `border-1 border-[#021d34] text-[#82acce] text-3xl hover:text-orange-700 hover:bg-[#021d34]/50 font-light w-[200px] h-[200px] flex flex-col` 
  ...
  >
    ...
    <div className="flex flex-col w-2/3 gap-6 items-center">
      ...
      <ul className="flex-wrap flex w-full justify-around">
        <a href="https://github.com/Thewilliamg">
